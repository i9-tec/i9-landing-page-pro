...
const Hero = () => {
  return (
    <section 
      id="home" 
      className="pt-28 pb-20 md:pt-32 md:pb-24 bg-gradient-to-br from-gray-50 via-gray-100 to-blue-50"
    >
      <div className="container mx-auto px-4">
        <div className="flex flex-col lg:flex-row items-center">
          <div className="lg:w-1/2 lg:pr-12 mb-10 lg:mb-0 animate-fade-in">
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-primary-800 mb-6 font-heading leading-tight">
            ...
            <div className="mt-8 flex items-center">
              ...
              <div className="ml-4 bg-blue-100 text-blue-800 rounded-full px-4 py-1 text-sm font-medium flex items-center">
